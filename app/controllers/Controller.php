...
abstract class Controller
{
    ...
    //                 case 'contain':
    //                     $searchQuery[] = "{$column['data']} LIKE :filterValue$index";
    //                     $params[":filterValue$index"] = '%' . $filterValue . '%';
    //                     break;
    //                 case 'notcontain':
    //                     $searchQuery[] = "{$column['data']} NOT LIKE :filterValue$index";
    //                     $params[":filterValue$index"] = '%' . $filterValue . '%';
    //                     break;
    //                 case 'equal':
    //                     $searchQuery[] = "{$column['data']} = :filterValue$index";
    //                     $params[":filterValue$index"] = $filterValue;
    //                     break;
    //                 case 'notequal':
    //                     $searchQuery[] = "{$column['data']} != :filterValue$index";
    ...
    //         $baseQuery .= " WHERE " . implode(" AND ", $searchQuery);
    //     }
